 ...
 * Purpose: Replicate code for lecture 5
 * 
 */
...
namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n");
            Console.Write("Enter value for inputNumber: ");
            ...
            Console.WriteLine($"Subraction: {Subtract(inputNumber1, inputNumber2)}");
            Console.WriteLine($"Mulitplication: {Multiply(inputNumber1, inputNumber2)}");
         ...
         * <param name="nameOfTheParameters"></param> used for describing one or more parameters in the method signature
        ...
        /// </summary>
        /// <param name="numl">Decimal inputs</param>
        /// <param name="num2">Decimal inputs</param>
        /// <returns>Sum of two decimal inputs</returns>
        static decimal Add(decimal numl, decimal num2)
        {
        ...
        /// </summary>
        /// <param name="num1">Decimal inputs</param>
        /// <param name="num2">Decimal inputs</param>
        /// <returns>Difference of two decimals inputs</returns>
        ...
        /// <summary>
        /// Method for multipling two numeric variables
        /// </summary>
        /// <param name="num1">Decimal inputs</param>
        /// <param name="num2">Decimal inputs</param>
        /// <returns>Products of two decimal inputs</returns>
